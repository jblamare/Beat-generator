...
if __name__ == "__main__":
    ...
    trainset_loader = torch.utils.data.DataLoader(dataset, collate_fn=custom_collate_fn_ordered, batch_size=32,
                                                  drop_last=True, sampler=train_sampler)
    valset_loader = torch.utils.data.DataLoader(dataset, collate_fn=custom_collate_fn_ordered, batch_size=32,
